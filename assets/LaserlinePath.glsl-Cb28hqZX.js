import{J4 as Pe,J0 as be,Ju as we,H0 as f,If as w,J6 as Ve,H1 as W,GZ as r,fv as j,wR as K,J3 as xe,HU as C,fT as ee,gH as T,hb as F,Jv as De,gj as te,Id as ie,Hz as M,fF as m,fU as v,Jw as ne,y_ as se,cx as o,mr as ae,ha as Ee,hv as ye,gG as Le,cm as re,gp as le,h8 as Se,J1 as Ce,x3 as Me,Hx as Ae,In as $e,GY as B,dj as Te,H3 as oe,H4 as ce,_ as he,p1 as Re,da as J,hw as q,O as c,T as z,k2 as de,k0 as pe,cr as Oe,cl as O,lw as Ie,HI as qe,lB as Ue,Jx as je,Hi as x,Ja as ze,Jb as G,Jy as He,n8 as Ne,Jz as R,JA as We,hq as Fe,uo as Be,hs as Je,ht as Ge,hu as ke,hx as Qe,Q as A,JB as Xe,dc as k}from"./index-CBCWb1so.js";import{t as Ze}from"./VisualElement-PLSMLb1e.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const H=j(6);function fe(t){const e=new K;e.include(xe),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>m(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>m(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new C("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(V,l),ee(V,V,u),T(d,V),d[3]=F(V),d)),new De("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,te(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
color = max(color, pointDistanceSphereColor * pointDistanceSphereAlpha);`)),t.lineVerticalPlaneEnabled&&(n.uniforms.add(new M("angleCutoff",i=>$(i)),new C("lineVerticalPlane",(i,s)=>Ke(i,s)),new w("lineVerticalStart",(i,s)=>et(i,s)),new w("lineVerticalEnd",(i,s)=>tt(i,s))),n.main.add(r`if (pointIsWithinLine(pos, lineVerticalStart, lineVerticalEnd)) {
...
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function $(t){return ae(it,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-j(2))))}function Ye(t,e){return m(I,t.pointDistanceOrigin,e.camera.viewMatrix),I[3]=te(t.pointDistanceOrigin,t.pointDistanceTarget),I}function Ke(t,e){const n=ye(t.lineVerticalPlaneSegment,.5,u),i=t.renderCoordsHelper.worldUpAtPosition(n,nt),s=T(V,t.lineVerticalPlaneSegment.vector),a=Le(u,i,s);return T(a,a),ge(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function et(t,e){const n=v(u,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function tt(t,e){const n=re(u,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function ge(t,e,n){return m(Q,t,n),v(d,e),d[3]=0,ne(d,d,n),Ee(Q,d,st)}const it=le(),u=o(),d=se(),nt=o(),V=o(),Q=o(),st=Se(),I=se(),at=Object.freeze(Object.defineProperty({__proto__:null,build:fe,defaultAngleCutoff:H},Symbol.toStringTag,{value:"Module"}));function _e(t){const e=new K;e.include(ue,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Ce("modelView",(a,{camera:l})=>Me(lt,l.viewMatrix,a.origin)),new Ae("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new $e("pixelToNDC",({camera:a})=>ae(rt,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
