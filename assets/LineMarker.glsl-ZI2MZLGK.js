import{wJ as ee,Id as te,Ie as ie,GO as re,GM as ae,If as se,Ig as oe,GR as o,I6 as ne,Hp as ce,I5 as le,GQ as _,Ih as pe,Ii as de,Ht as N,GP as he,GS as ve,GT as ue,HM as me,GV as fe,Ij as j,Ik as R,Il as ge,Im as Se,Hu as Pe,kl as ye,GX as we,kn as _e,GY as ze,_ as xe,GZ as M,G_ as E,G$ as $e,H0 as G,H1 as L,Hw as be,H3 as Te,H4 as ke,H5 as Ve,H7 as k,H8 as Oe,In as De,Io as U,Ip as B,Iq as We,Ir as Ce,Is as Me,O as c,T as Le,H9 as Ie,Ha as d,fk as Ae,Hx as Fe,It as q,ru as He,HY as Ne,Iu as je,Hd as Re,ck as Y,lo as Ee,fJ as J,cw as Q,Iv as Ge}from"./index-caYVuhRd.js";function X(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),P&&(e.include(R),S.constants.add("relativeMarkerSize","float",ge/j).constants.add("relativeTipLineWidth","float",Se).code.add(o`
