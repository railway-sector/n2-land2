import{JV as be,JR as we,Ka as Ve,ys as f,yB as w,J_ as De,Ip as F,yt as r,e8 as j,xU as ee,JU as xe,yz as L,bt as te,bq as A,hg as B,Kb as ye,hG as ie,yr as ne,IK as S,fj as _,bp as v,Kc as se,yD as ae,br as o,mG as re,hf as Ee,rT as Le,bu as Se,bF as le,gg as oe,hd as Ce,JS as Me,y6 as Ae,II as $e,Jh as Re,yC as H,cN as Te,qV as ce,qX as he,_ as de,fl as Ie,cE as G,qv as q,E as c,G as z,k8 as pe,fm as ue,bn as Oe,bs as O,lP as Ue,IV as qe,lR as je,Kd as ze,yK as D,of as Ne,og as K,Ke as We,nj as Fe,Kf as $,Kg as Be,xf as J,rP as He,va as Ge,rQ as Ke,rR as Je,rS as ke,rU as Xe,F as C,Kh as Qe,cG as k}from"./index-BjDGJEMq.js";import{t as Ze}from"./VisualElement-BFfLISKx.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(Ve),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new F("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new L("heightPlane",(s,a)=>me(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new L("pointDistanceSphere",(i,s)=>Ye(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
