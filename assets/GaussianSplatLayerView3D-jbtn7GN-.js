...
}`)}let Ti=class extends Ce{constructor(){super(...arguments),this.tileCameraPosition=H(),this.cameraDelta=H()}};function Ci(i){i.code.add(_`vec4 unpackColor(uvec4 packedGaussian) {
vec4 color;
